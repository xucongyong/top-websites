---
title: VNPY -Tutorialumwelt installieren 0x01
description: vnpy_tutorial_0x01_envrionment_install
keywords: VNPY, Quant Tutorial, Futu FUTU -Umgebung
date: 2024-09-05
category: "quant" 
---
...
*[Python](https://www.tutorialspoint.com/python/index.htm) oder "Python Python" 

Nach "Python Python" wird nicht zu mir kommen. 50 Fragen werden möglich.
...
Windows und Ubuntu sind relativ einfach. Direkte Referenz [Vnpy](https://github.com/vnpy/vnpy.git) einfach geh.

## MAC installieren

*[Miniconda](https://docs.conda.io/en/latest/miniconda.html) 

Ausgewählt: Miniconda3 macOSX 64-Bit-PKG-Installation
...
# Das Framework vnpy_futu kann den Datenbericht nicht lesen:


Futu_gateway.py, Sie können von vnpy_futu importieren futugateway klicken
...
## So führen Sie VSCODE -Debugg aus

Schicht + Befehl + P->`Python: Select Interpreter` wählen Sie vnpy_env
